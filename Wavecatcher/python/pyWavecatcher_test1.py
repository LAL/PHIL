...
#DeviceHandle=ctypes.POINTER(FILE)
#DeviceHandle=ctypes.c_int
...
#    wcDll.WAVECAT64CH_OpenDevice.argtypes=[ctypes.POINTER]
    return wcDll.WAVECAT64CH_OpenDevice()
#    return wcDll.WAVECAT64CH_OpenDevice()
#     return wcDll.WAVECAT64CH_OpenDevice(ctypes.POINTER(DeviceHandle))
#    return wcDll.WAVECAT64CH_OpenDevice(DeviceHandle)
